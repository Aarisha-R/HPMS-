...
import com.hospital.hpms.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<Void> logout() {
        // Stateless JWT: client discards token. Token blacklisting can be added via a
        // denylist store (e.g. Redis) keyed by token id for stronger logout semantics.
        return ResponseEntity.ok().build();
    }
}
